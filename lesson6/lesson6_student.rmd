...
qplot(data = diamonds, x = carat, y = price, 
      x_lim = c(0, quantile(diamonds$carat, .99)), 
      y_lim = c(0, quantile(diamonds$price, .99)))
```

```{r Scatterplot Review with ggplot}
...
plot1 <- qplot(price, data = diamonds, geom = "histogram") + 
  ggtitle('Price')

plot2 <- qplot(price, data = diamonds, geom = "histogram") +
  scale_x_log10() +
  ggtitle('Price (log10)')
